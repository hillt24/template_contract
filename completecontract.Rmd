...
- [ ] `r advdate(dayone, 8, topic)`
  - Finish Lab 8 by `r startweek`:  `r advdate(dayone, 8, assignment=startweek)`
   - Finish portfolio piece 5 by `r startweek`:  `r advdate(dayone, 8, assignment=startweek)`
...
- [ ] `r advdate(dayone, 12, topic)`
  ...
  - Finish portfolio piece 8 by `r startweek`:  `r advdate(dayone, 13, assignment=startweek)`
...
- [ ] `r advdate(dayone, 14, topic)`
  - Finish portfolio pieces 9 by `r startweek`:  `r advdate(dayone, 15, assignment=startweek)`
